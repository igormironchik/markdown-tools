...
KSyntaxHighlighting::Definition Syntax::definitionForName(const QString &name) const
{
...
KSyntaxHighlighting::Theme Syntax::themeForName(const QString &name) const
{
...
Syntax::Colors Syntax::prepare(const QStringList &lines)
{
