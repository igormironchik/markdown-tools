...
var hljs = (function () {
  ...
  */
  ...
  function swift(hljs) {
    ...
    const BUILT_IN = {
      scope: 'built_in',
      match: concat(/\b/, either(...builtIns$1), lookahead(TRAILING_PAREN_REGEX)),
    };
    ...
    const FUNCTION_IDENT = either(QUOTED_IDENTIFIER.match, identifier, operator);
    ...
    const METHODS_ONLY = [...keywords, ...builtIns$1];
    const FUNCTION_CALL = {
      variants: [
        {
          match: [
