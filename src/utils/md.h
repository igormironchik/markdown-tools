...
static const char *s_autolinks = QT_TRANSLATE_NOOP(
    ...
    "delimit them, although they will be recognized under a smaller set of circumstances. All such recognized "
    "autolinks "
...
static const char *s_rawHtml = QT_TRANSLATE_NOOP(
    ...
    "<p>A declaration consists of the string <code>&lt;!</code>, an ASCII letter, zero or more characters not "
    "including "
