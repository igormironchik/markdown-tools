...
mat3[4] v_4(uint start_byte_offset) {
  mat3 a_2[4] = mat3[4](mat3(vec3(0.0f), vec3(0.0f), vec3(0.0f)), mat3(vec3(0.0f), vec3(0.0f), vec3(0.0f)), mat3(vec3(0.0f), vec3(0.0f), vec3(0.0f)), mat3(vec3(0.0f), vec3(0.0f), vec3(0.0f)));
  {
    uint v_5 = 0u;
    v_5 = 0u;
    while(true) {
...
void main() {
  ...
  float v_9 = (v_8 + c(uintBitsToFloat(v_1.inner[3u].xyz).zxy));
  v_2.inner = (v_9 + d(uintBitsToFloat(v_1.inner[3u].xyz).zxy.x));
}
