...
fn make_array() -> array<subgroup_matrix_left<f32, 8, 8>, 2> {
  if (non_uniform_condition) {
    return array<subgroup_matrix_left<f32, 8, 8>, 2>(
...
fn make_nested_array() -> array<array<subgroup_matrix_left<f32, 8, 8>, 2>, 2> {
  ...
  if (non_uniform_condition) {
    return array<array<subgroup_matrix_left<f32, 8, 8>, 2>, 2>(
    ...
    return array<array<subgroup_matrix_left<f32, 8, 8>, 2>, 2>(
             ...
             array<subgroup_matrix_left<f32, 8, 8>, 2>(
               subgroup_matrix_left<f32, 8, 8>(-100),
               subgroup_matrix_left<f32, 8, 8>(-1),
             )
           );
  }
}
fn make_struct() -> S {
  if (non_uniform_condition) {
    ...
    return S(
             subgroup_matrix_left<f32, 8, 8>(-7),
             subgroup_matrix_right<f32, 8, 8>(-42),
           );
  }
}
