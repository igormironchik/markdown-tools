...
mat4 getFrameData_f1_(inout float frameID) {
  float fX = 0.0f;
  float x_15 = frameID;
  uvec4 v_1 = v.inner[6u];
  float x_25 = uintBitsToFloat(v_1.w);
  fX = (x_15 / x_25);
  float x_37 = fX;
  ...
  vec4 v_2 = vec4(x_40.x, x_40.y, x_40.z, x_40.w);
  vec4 v_3 = vec4(x_47.x, x_47.y, x_47.z, x_47.w);
  return mat4(v_2, v_3, vec4(x_54.x, x_54.y, x_54.z, x_54.w), vec4(0.0f));
}
...
void main_1() {
  ...
  vec2 x_95 = tUV;
  tileID = floor(x_95);
  vec2 x_101 = uintBitsToFloat(v.inner[6u].xy);
  sheetUnits = (vec2(1.0f) / x_101);
  uvec4 v_4 = v.inner[6u];
  float x_106 = uintBitsToFloat(v_4.w);
  spriteUnits = (1.0f / x_106);
  vec2 x_111 = uintBitsToFloat(v.inner[5u].zw);
  ...
  i = 0;
  {
    ...
    while(true) {
      ...
      switch(x_126) {
        ...
        {
          vec2 x_150 = tileID;
          vec2 x_154 = uintBitsToFloat(v.inner[5u].zw);
        ...
        {
          vec2 x_136 = tileID;
          vec2 x_140 = uintBitsToFloat(v.inner[5u].zw);
      ...
      uvec4 v_5 = v.inner[6u];
      float x_169 = uintBitsToFloat(v_5.w);
      ...
      if ((x_174 > 0.0f)) {
        ...
        float x_181 = uintBitsToFloat(v_6.x);
        ...
        f = 0.0f;
        {
          ...
          while(true) {
            ...
            uvec4 v_7 = v.inner[6u];
            float x_211 = uintBitsToFloat(v_7.w);
            float x_214 = f;
      ...
      if ((x_254 == 0)) {
        ...
        vec4 x_292 = nc;
        float x_295 = nc.w;
        vec3 v_9 = vec3(x_290.x, x_290.y, x_290.z);
        vec3 v_10 = vec3(x_292.x, x_292.y, x_292.z);
        mixed = mix(v_9, v_10, vec3(x_295, x_295, x_295));
        vec3 x_298 = mixed;
        float x_299 = alpha;
