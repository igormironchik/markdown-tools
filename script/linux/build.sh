...
cmake $build_opts -DCMAKE_BUILD_TYPE=$build_type -S . -B build-markdown-tools -DBUILD_MDPDF_TESTS=$build_tests -DCMAKE_PREFIX_PATH=$PWD/Qt/$qt_version/gcc_64 -DECM_DIR=$PWD/../KDE/share/ECM/cmake -DKF6WidgetsAddons_DIR=$PWD/../KDE/lib/x86_64-linux-gnu/cmake/KF6WidgetsAddons -DKF6SyntaxHighlighting_DIR=$PWD/../KDE/lib/x86_64-linux-gnu/cmake/KF6SyntaxHighlighting -DKF6Sonnet_DIR=$PWD/../KDE/lib/x86_64-linux-gnu/cmake/KF6Sonnet || exit 1
