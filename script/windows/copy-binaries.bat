...
copy /Y Qt\6.7.2\msvc2019_64\bin installer\packages\mironchik.igor.markdown\data\bin
...
copy /Y Qt\6.7.2\msvc2019_64\bin\QtWebEngineProcess.exe installer\packages\mironchik.igor.markdown\data\bin\QtWebEngineProcess.exe

IF %ERRORLEVEL% NEQ 0 (
	exit /B %ERRORLEVEL%
)

xcopy Qt\6.7.2\msvc2019_64\plugins installer\packages\mironchik.igor.markdown\data\plugins /S /Y

IF %ERRORLEVEL% NEQ 0 (
	exit /B %ERRORLEVEL%
)

xcopy Qt\6.7.2\msvc2019_64\resources installer\packages\mironchik.igor.markdown\data\resources /S /Y

IF %ERRORLEVEL% NEQ 0 (
	exit /B %ERRORLEVEL%
)

xcopy Qt\6.7.2\msvc2019_64\translations installer\packages\mironchik.igor.markdown\data\translations /S /Y
